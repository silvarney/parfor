...
@section('body_page')
    ...
    <div class="shadow p-3 mb-5 bg-body rounded formGeral">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" onclick="redirect()" aria-selected="false">Lista</a>
            </li>
          </ul>
          ...
          <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <form @if(!isset($professor)) action="{{route('admin.created-professor')}}" @else action="{{ route('admin.update-professor') }}" @endif method="post">
                    @csrf
    ...
    @push('scripts')
        ...
        <script>
            ...
            function redirect() {
                window.location.href = "/admin/professor#profile";
            }
